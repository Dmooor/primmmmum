...
const discord_token = "NjI4MDAyMTYwMzI3Nzg2NDk2.XtrFQg.Q63hmcvDfNsL7NHnvVw1wiN_gQ0";
...
client.on("message", message => {
 if (message.content === "-invite") {
  const embed = new Discord.RichEmbed()
      .setColor("RANDOM")
      .setFooter('© Dmar Bot :heart: جميع الحقوق محفوظة 2019 لــبوت')
      .addField('شكرا لك لاستخدامك ل دمار بوت', `https://discordapp.com/api/oauth2/authorize?client_id=576789421857177677&permissions=0&scope=bot`)
...
client.on('message', message => {
    ...
    message.channel.send({
        embed: new Discord.RichEmbed()
            ...
            .addField('``الرامات المستخدمة ??``', `[${(process.memoryUsage().rss / 1048576).toFixed()}MB]`, true)
            ...
            .addField('``الايدي تبعي ??``' , `[ ${client.user.id} ]` , true)
			      .addField('``امر تشغيلي ??``' , `[ - ]` , true)
			      .addField('``الغه التي  تبرمجت بها ??``' , `[ Java Script ]` , true)
